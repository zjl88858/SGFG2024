...
Public Class Main
    ...
    Private Sub BackgroundWorkerConn_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorkerConn.DoWork
        ...
        process.StartInfo.Arguments = "--listen=" & PROXY_METHOD_STR & "://" & PROXY_LISTEN_STR & ":7788 --proxy=https://sgfg:" & PROXY_PASSWORD_STR & "@" & PROXY_SERVER_STR & ":443"
        process.StartInfo.UseShellExecute = False
        process.StartInfo.CreateNoWindow = True
        process.StartInfo.RedirectStandardOutput = True
        process.Start()
