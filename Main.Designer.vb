...
Partial Class Main
    ...
    Private Sub InitializeComponent()
        ...
        Dim TreeNode1 As TreeNode = New TreeNode("龟苓膏")
        Dim TreeNode2 As TreeNode = New TreeNode("烧仙草")
        ...
        TreeNode2.Name = "s02"
        TreeNode2.Text = "烧仙草"
        UiNavMenu1.Nodes.AddRange(New TreeNode() {TreeNode1, TreeNode2})
        ...
        UiNavMenu1.Size = New Size(207, 103)
